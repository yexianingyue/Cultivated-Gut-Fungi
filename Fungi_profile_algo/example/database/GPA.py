...
def get_args():
    ...
    parser.add_argument('-l', metavar='',type=str, default=f"{MYDIR}/clu.uniq_gene.sum", help=f'length file ({MYDIR}/clu.len)')
    parser.add_argument('-m', metavar='',type=str, default=f"{MYDIR}/gene2clu.map", help=f'gene mapping file ({MYDIR}/gene.clu)')
